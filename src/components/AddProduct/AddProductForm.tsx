...
const AddProductForm = ({handleProductForm}) => {
    ...
    <form>
      <div className="-mx-4 flex flex-col flex-wrap">
        ...
        <div className="flex w-full px-4">
          <button onClick={handleProductForm} className="inline-block rounded-sm bg-primary px-8 py-3 text-base font-medium text-white shadow-submit duration-300 hover:bg-primary/90 dark:shadow-submit-dark">
            Save
          </button>
        </div>
      </div>
