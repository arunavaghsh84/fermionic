              ...
              <div className="mx-auto max-w-[800px] text-center">
                ...
                <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                  <Link
                    ...
                    href="#"
                    className="wow animate__animated animate__tada  rounded-sm bg-primary px-8 py-4 text-base font-semibold text-white duration-300 ease-in-out hover:bg-primary/80"
                  >
                    Join Now
                  </Link>
                </div>
      ...
      >
        <div>
          <Image
            ...
            height={925}
          />
          <div className="absolute top-16 z-10 ml-10 mt-16 max-w-[550px] pl-10 pt-16">
